...
val CORDAPPS = listOf("io.cordacademy.obligation.v1.contract", "io.cordacademy.obligation.v2.contract")
val CONTRACTS = listOf(ObligationContract.ID)

val OBLIGATION_STATE =
    ObligationState(IDENTITY_A.party, IDENTITY_B.party, 100.POUNDS)
